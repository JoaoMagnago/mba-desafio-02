...
export default function SignUp() {
  ...
  return (
    <div className="grid grid-cols-2 justify-items-center mb-auto min-h-screen">
      ...
      <div className="flex flex-col gap-[8.1875rem] mt-6 bg-white rounded-[2rem] py-[4.5rem] px-[5rem] overflow-y-auto">
        <div className="flex flex-col gap-10">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex flex-col items-center justify-center size-[7.5rem] bg-shape rounded-xl">
              <ImageUploadIcon fill={'#F24D0D'} />
            </div>
          </div>
